...
1. **Discover Facts First:** Search and read the codebase to inspect existing models, dependencies, and code conventions yourself. Never ask the user for information discoverable from the repository.
